...
function generarTicket(pedido) {
    ...
    contenido.innerHTML = `
        ...
        <div class="ticket-footer">
            ...
            ❤️ Gracias por preferir el rincon del sabor ❤️
...
Gracias por preferir r el rincon del sabo❤️`;
...
function enviarCorreo() {
    ...
    const asunto =
        ...
        `Pedido #${ultimoPedido.numero} - el rincon del sabor`;
...
Gracias por preferir el rincon del sabor.
